export default {
  ...
  fields: [
    ...
    {
      name: "displayName",
      title: "Display Name (Custom)",
      type: "string",
      description: "Custom name to display (e.g., 'My Vimeo Channel'). If empty, uses platform name",
    },
    {
      name: "icon",
      title: "Icon (Custom)",
      type: "string",
      description: "Icon name or emoji (e.g., '🎬' for Vimeo, 'vimeo' for icon library)",
    },
    {
      name: "displayOrder",
      title: "Display Order",
